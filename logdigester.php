...
error_reporting(0); //ignore any errors that this script makes :)
//================================================================================================
//================================================================================================
?>
...
<?php if(empty($_GET['display_error'])) { ?>
	...
	<?php
	if(!empty($filter)) {
		?><form action="logdigester.php" method="get"><select name='f'><option value="">NONE</option><?php
		foreach($filter as $f) {
			?>
...
<?php } else if(!empty($allow_show_source)) { ?>
	<div class="instructions">
	<b><a href="http://www.jakeo.com/software/logdigester/index.php">Log Digester</a> Output</b> from <a href="logdigester.php"><?=$file?></a><br />
